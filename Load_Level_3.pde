...
void loadLevel3(){
  ...
  obsticles[1][20] = new object(180, 450,grassWidth,grassHeight,0,0,0,0,0,0,1); // first grass
  obsticles[1][21] = new object(180, 400,grassWidth,grassHeight,0,0,0,0,0,0,1); // first, second grass
  obsticles[1][22] = new object(180, 350,grassWidth,grassHeight,0,0,0,0,0,0,1); // first, third grass
  obsticles[1][23] = new object(180, 300,grassWidth,grassHeight,0,0,0,0,0,0,1); // first, fourth grass
  ...
  obsticles[1][30] = new object(250, 500,buttonWidth,buttonHeight,0,0,0,0,0,0,4); // first button 
  ...
  obsticles[1][38] = new object(510, 510,wafflesWidth,wafflesHeight,0,0,0,0,0,0,13); // second waffle
