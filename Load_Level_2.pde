...
void loadLevel2(){
  ...
  obsticles[1][37] = new object(970,530,300,175,0,0,0,0,0,0,0); // ground 3
  ...
  obsticles[1][7] = new object(-10,0,10,200,0,0,0,0,0,0,0); // fourth wall
  ...
  obsticles[1][37] = new object(100,100,0,0,0,0,0,0,0,0,10); 
  ...
  obsticles[2][14] = new object(220,230,20,10,0,0,0,0,0,0,0); //donkey third platform
  ...
  obsticles[2][25] = new object(150,530,70,10,1,150,200,0,0,0,0); // platform (not moving)
  //obsticles[2][26] = new object(520,530,60,10,0,0,0,0,0,0,0); //second platform (not moving)
  ...
  obsticles[2][29] = new object(660,230,50,10,0,0,0,1,330,230,0); //fifth platform (not moving)
  ...
  obsticles[2][38] = new object(100,100,0,0,0,0,0,0,0,0,11); //Level 3
  ...
  obsticles[2][41] = new object(840,400,buttonWidth,buttonHeight,0,0,0,0,0,0,4); //button 
  ...
  obsticles[2][45] = new object(630,530,wafflesWidth,wafflesHeight,0,0,0,0,0,0,13); //waffle 
  obsticles[2][46] = new object(980,70,wafflesWidth,wafflesHeight,0,0,0,0,0,0,13); //waffle 
  obsticles[2][47] = new object(520,310,20,10,0,0,0,0,0,0,0); //cancel
  obsticles[2][48] = new object(520,450,20,10,0,0,0,0,0,0,0); //cancel
